  ...
  "ai-agents-workshop": [
    {
      ...
      type: "select",
      required: true,
      options: ["AIDS", "COMPS", "IT", "EXTC", "MECH", "ETRX", "Other"],
    },
    {
      key: "year",
      label: "Year of Study",
    ...
    },
    {
      ...
      hint: "Bringing your own is strongly recommended — lab machines are limited and you'll leave with your environment already working.",
    },
    {
      key: "os",
